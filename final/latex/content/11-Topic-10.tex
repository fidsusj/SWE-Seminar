\chapter{Testing Non-Functional requirements with Aspects}\label{sec:topic_10}
...
The approaches have been compared using a set of synthesis questions, as shown in \autoref{syn}.\\
\\
